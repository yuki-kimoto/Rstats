  ...
  namespace Func {
    ...
    SV* as_character(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "character")) {
        ...
        v2 = Rstats::VectorFunc::new_vector<Rstats::Character>(0);
        Rstats::Func::set_vector(sv_r, sv_x_out, v2);
      }
      else {
    ...
    SV* as_double(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "character")) {
        ...
        v2 = Rstats::VectorFunc::new_vector<Rstats::Double>(0);
        Rstats::Func::set_vector(sv_r, sv_x_out, v2);
      }
      else {
    ...
    SV* as_complex(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "character")) {
        ...
        v2 = Rstats::VectorFunc::new_vector<Rstats::Complex>(0);
        Rstats::Func::set_vector(sv_r, sv_x_out, v2);
      }
      else {
    ...
    SV* as_integer(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "character")) {
        ...
        v2 = Rstats::VectorFunc::new_vector<Rstats::Integer>(0);
        Rstats::Func::set_vector(sv_r, sv_x_out, v2);
      }
      else {
    ...
    SV* as_logical(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "character")) {
        ...
        v2 = Rstats::VectorFunc::new_vector<Rstats::Logical>(0);
        Rstats::Func::set_vector(sv_r, sv_x_out, v2);
      }
      else {
    ...
    SV* sum(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "complex")) {
        ...
        Rstats::Vector* v2 = Rstats::VectorFunc::new_vector<Rstats::Logical>(1);
        Rstats::Logical v2_total(0);
        for (Rstats::Logical i = 0; i < length; i++) {
          v2_total += v1->get_value<Rstats::Logical>(i);
        }
        v2->set_value<Rstats::Logical>(0, v2_total);
        for (Rstats::Logical i = 0; i < length; i++) {
          if (v1->exists_na_position(i)) {
            v2->add_na_position(0);
            break;
