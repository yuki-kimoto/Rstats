  ...
  namespace VectorFunc {
    ...
    IV get_length (Rstats::Vector* v1) {
      ...
      switch (type) {
        case Rstats::Type::CHARACTER :
          return Rstats::VectorFunc::get_values2<Rstats::Character>(v1)->size();
          break;
        case Rstats::Type::COMPLEX :
          return Rstats::VectorFunc::get_values2<Rstats::Complex>(v1)->size();
          break;
        case Rstats::Type::DOUBLE :
          return Rstats::VectorFunc::get_values2<Rstats::Double>(v1)->size();
          break;
    ...
    void delete_vector (Rstats::Vector* v1) {
      ...
      if (v1->values != NULL){ 
        switch (type) {
          case Rstats::Type::CHARACTER : {
            std::vector<SV*>* values = Rstats::VectorFunc::get_values2<Rstats::Character>(v1);
            for (IV i = 0; i < length; i++) {
              if ((*values)[i] != NULL) {
          ...
          case Rstats::Type::COMPLEX : {
            std::vector<std::complex<NV> >* values = Rstats::VectorFunc::get_values2<Rstats::Complex>(v1);
            delete values;
            break;
          }
          case Rstats::Type::DOUBLE : {
            std::vector<NV>* values = Rstats::VectorFunc::get_values2<Rstats::Double>(v1);
            delete values;
            break;
          }
          case Rstats::Type::INTEGER :
          case Rstats::Type::LOGICAL : {
            std::vector<IV>* values = Rstats::VectorFunc::get_values2<Rstats::Integer>(v1);
            delete values;
          }
        }
      }
    ...
    SV* get_character_value(Rstats::Vector* v1, IV pos) {
      SV* value = (*Rstats::VectorFunc::get_values2<Rstats::Character>(v1))[pos];
      if (value == NULL) {
        return NULL;
      }
      else {
    ...
    void set_character_value(Rstats::Vector* v1, IV pos, SV* value) {
      if (value != NULL) {
        SvREFCNT_dec((*Rstats::VectorFunc::get_values2<Rstats::Character>(v1))[pos]);
      }
      
      SV* new_value = Rstats::pl_new_sv_sv(value);
      (*Rstats::VectorFunc::get_values2<Rstats::Character>(v1))[pos] = SvREFCNT_inc(new_value);
    }
    ...
    std::complex<NV> get_complex_value(Rstats::Vector* v1, IV pos) {
      return (*Rstats::VectorFunc::get_values2<Rstats::Complex>(v1))[pos];
    }

    void set_complex_value(Rstats::Vector* v1, IV pos, std::complex<NV> value) {
      (*Rstats::VectorFunc::get_values2<Rstats::Complex>(v1))[pos] = value;
    }
    ...
    NV get_double_value(Rstats::Vector* v1, IV pos) {
      return (*Rstats::VectorFunc::get_values2<Rstats::Double>(v1))[pos];
    }

    void set_double_value(Rstats::Vector* v1, IV pos, NV value) {
      (*Rstats::VectorFunc::get_values2<Rstats::Double>(v1))[pos] = value;
    }
    ...
    IV get_integer_value(Rstats::Vector* v1, IV pos) {
      return (*Rstats::VectorFunc::get_values2<Rstats::Integer>(v1))[pos];
    }

    void set_integer_value(Rstats::Vector* v1, IV pos, IV value) {
      (*Rstats::VectorFunc::get_values2<Rstats::Integer>(v1))[pos] = value;
    }
