...
# comparison operator
{
  ...
  {
    my $z1 = Rstats::VectorFunc::new_complex(1,2);
    my $z2 = Rstats::VectorFunc::new_complex(1,2);
  ...
  {
    my $z1 = Rstats::VectorFunc::new_complex(1,2);
    my $z2 = Rstats::VectorFunc::new_complex(1,1);
    my $ret = Rstats::VectorFunc::equal($z1, $z2);
...
# to_string
{
  ...
  {
    my $z1 = Rstats::VectorFunc::new_complex(1,0);
    is("$z1", "1+0i");
  }
  
  # to_string - image number is minus
  {
    my $z1 = Rstats::VectorFunc::new_complex(1, -1);
    is("$z1", "1-1i");
  }
}
...
# operation
{
  ...
  {
    my $z1 = Rstats::VectorFunc::new_complex(1,2);
    my $z2 = Rstats::VectorFunc::new_complex(3,4);
  ...
  # operation - abs
  {
    my $z1 = Rstats::VectorFunc::new_complex(3, 4);
  ...
  # operation - divide
  {
    my $z1 = Rstats::VectorFunc::new_complex(5, -6);
    my $z2 = Rstats::VectorFunc::new_complex(3, 2);
  ...
  {
    my $z1 = Rstats::VectorFunc::new_complex(1, 2);
    my $z2 = Rstats::VectorFunc::new_complex(3, 0);
