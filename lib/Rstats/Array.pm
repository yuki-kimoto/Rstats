...
use overload
  ...
  '**' => sub { Rstats::ArrayFunc::pow(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '<' => sub { Rstats::ArrayFunc::less_than(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '<=' => sub { Rstats::ArrayFunc::less_than_or_equal(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '>' => sub { Rstats::ArrayFunc::more_than(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '>=' => sub { Rstats::ArrayFunc::more_than_or_equal(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '==' => sub { Rstats::ArrayFunc::equal(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '!=' => sub { Rstats::ArrayFunc::not_equal(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '&' => sub { Rstats::ArrayFunc::and(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
  '|' => sub { Rstats::ArrayFunc::or(undef(), Rstats::ArrayFunc::_fix_pos(@_)) },
