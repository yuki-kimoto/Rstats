...
sub NA {
  my $r = shift;
  return defined $na ? $na : $na = Rstats::Func::Array::new_logical($r, undef);
}

sub NaN {
  my $r = shift;
  return Rstats::Func::Array::new_double($r, 'NaN');
}

sub Inf {
  my $r = shift;
  return Rstats::Func::Array::new_double($r, 'Inf');
}

my $false;
sub FALSE {
  my $r = shift;
  return defined $false ? $false : $false = Rstats::Func::Array::new_logical($r, 0);
}
...
sub TRUE {
  my $r = shift;
  return defined $true ? $true : $true = Rstats::Func::Array::new_logical($r, 1);
}
sub T {
  my $r = shift;
  return TRUE
...
sub I {
  ...
  my $x2 = Rstats::Func::Array::c($r, $x1);
...
sub subset {
  ...
  $x_names = Rstats::Func::Array::NULL() unless defined $x_names;
...
sub transform {
  ...
  while (my ($new_name, $new_v) = splice(@args, 0, 2)) {
    if (Rstats::Func::is_character($r, $new_v)) {
      $new_v = Rstats::Func::Array::I($r, $new_v);
    }
  ...
  my $x2 = Rstats::Func::Array::data_frame($r, @new_args);
...
sub read_table {
  ...
  for (my $i = 0; $i < $row_size; $i++) {
    ...
    if ($type eq 'character') {
      my $x1 = Rstats::Func::Array::c($r, @{$columns->[$i]});
  ...
  my $d1 = Rstats::Func::Array::data_frame($r, @$data_frame_args);
...
sub interaction {
  ...
  $x_sep = Rstats::Func::Array::c($r, ".") unless defined $x_sep;
  my $sep = $x_sep->value;
  
  $x_drop = Rstats::Func::Array::FALSE() unless defined $x_drop;
  ...
  if ($x_drop) {
    ...
    $f1 = factor($r, c($r, @$f1_elements), {levels => Rstats::Func::Array::c($r, @$f1_levels_elements)});
  }
...
sub gl {
  ...
  my $n = $x_n->value;
  my $k = $x_k->value;
  $x_length = Rstats::Func::Array::c($r, $n * $k) unless defined $x_length;
  my $length = $x_length->value;
  
  my $x_levels = Rstats::Func::Array::c($r, 1 .. $n);
  ...
  my $x1 = Rstats::Func::Array::c($r, @$x1_elements);
  
  $x_labels = $x_levels unless defined $x_labels;
  $x_ordered = Rstats::Func::Array::FALSE() unless defined $x_ordered;
...
sub ordered {
  ...
  $opt->{ordered} = Rstats::Func::Array::TRUE();
...
sub factor {
  ...
  unless (defined $x_levels) {
    $x_levels = Rstats::Func::Array::sort($r, unique($r, $x1), {'na.last' => TRUE});
  }
  ...
  if (defined $x_exclude->value && Rstats::Func::length($r, $x_exclude)->value) {
    ...
    $x_levels = Rstats::Func::Array::c($r, @$new_a_levels_values);
  }
  ...
  my $f1 = Rstats::Func::Array::new_integer($r, @$f1_values);
  if ($x_ordered) {
    $f1->{class} = Rstats::Func::Vector::new_character('factor', 'ordered');
  }
  else {
    $f1->{class} = Rstats::Func::Vector::new_character('factor');
  }
...
sub list {
  ...
  @elements = map { ref $_ ne 'Rstats::List' ? Rstats::Func::Array::to_c($r, $_) : $_ } @elements;
...
sub data_frame {
  ...
  for (my $i = 0; $i < @$counts; $i++) {
    ...
    if ($repeat > 1) {
      ...
      $elements->[$i] = Rstats::Func::Array::c($r, @$repeat_elements);
    }
  }
  ...
  Rstats::Func::dimnames(
    $r,
    $data_frame,
    Rstats::Func::Array::list(
      $r,
      Rstats::Func::Array::c($r, @$row_names),
      Rstats::Func::Array::c($r, @$column_names)
    )
  );
...
sub upper_tri {
  ...
  if (Rstats::Func::is_matrix($r, $x1_m)) {
    ...
    my $x2 = matrix($r, Rstats::Func::Array::new_logical($r, @$x2_values), $rows_count, $cols_count);
...
sub kronecker {
  ...
  ($x1, $x2) = Rstats::Func::Array::upgrade_type($r, $x1, $x2) if $x1->type ne $x2->type;
  ...
  my $x3 = array($r, c($r, @$x3_values), Rstats::Func::Array::c($r, @$x3_dim_values));
...
sub outer {
  ...
  my $x3 = array($r, c($r, @$x3_values), Rstats::Func::Array::c($r, @$x3_dim));
...
sub Mod {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::Mod, @_);
}

sub Arg {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::Arg, @_);
}
...
sub sub {
  ...
  my $x2 = Rstats::Func::Array::new_character($r, @$x2_values);
...
sub grep {
  ...
  return Rstats::Func::Array::new_double($r, @$x2_values);
}
...
sub col {
  ...
  return array($r, c($r, @values), Rstats::Func::Array::c($r, $nrow, $ncol));
}
...
sub Conj {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::Conj, @_);
}

sub Re {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::Re, @_);
}

sub Im {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::Im, @_);
}
...
sub nrow {
  ...
  if (Rstats::Func::is_data_frame($r, $x1)) {
    return Rstats::Func::Array::c($r, $x1->{row_length});
  }
  elsif (Rstats::Func::is_list($r, $x1)) {
    return Rstats::Func::Array::NULL();
  }
  else {
    return Rstats::Func::Array::c($r, Rstats::Func::dim($r, $x1)->values->[0]);
  }
}
...
sub is_element {
  ...
  return Rstats::Func::Array::new_logical($r, @$x3_values);
}
...
sub setequal {
  ...
  my $x3 = Rstats::Func::Array::sort($r, $x1);
  my $x4 = Rstats::Func::Array::sort($r, $x2);
  ...
  for (my $i = 0; $i < $x3->length_value; $i++) {
    unless (Rstats::Func::Vector::equal($x3_elements->[$i], $x4_elements->[$i])->value) {
      $not_equal = 1;
      last;
    }
  }
...
sub setdiff {
  ...
  for my $x1_element (@$x1_elements) {
    ...
    for my $x2_element (@$x2_elements) {
      if (Rstats::Func::Vector::equal($x1_element, $x2_element)->value) {
        $match = 1;
        last;
      }
    }
  ...
  return Rstats::Func::Array::c($r, @$x3_elements);
}
...
sub union {
  ...
  my $x3 = Rstats::Func::Array::c($r, $x1, $x2);
  my $x4 = unique($r, $x3);
...
sub diff {
  ...
  for (my $i = 0; $i < $x1->length_value - 1; $i++) {
    ...
    my $x2_element = Rstats::Func::Vector::subtract($x1_element2, $x1_element1);
    push @$x2_elements, $x2_element;
  }
  my $x2 = Rstats::Func::Array::c($r, @$x2_elements);
  Rstats::Func::copy_attrs_to($r, $x1, $x2);
  ...
  if ($x1->vector->type eq 'character') {
    ...
    for my $x1_element (@{Rstats::Func::decompose($r, $x1)}) {
      if (Rstats::Func::is_na($r, $x1_element)->value) {
        ...
        my $x2_element = Rstats::Func::Vector::new_double(CORE::length $x1_element->value);
        push @$x2_elements, $x2_element;
      }
    }
    my $x2 = Rstats::Func::Array::c($r, @$x2_elements);
  ...
  if ($x1->vector->type eq 'character') {
    ...
    for my $x1_element (@{Rstats::Func::decompose($r, $x1)}) {
      if (Rstats::Func::is_na($r, $x1_element)->value) {
        ...
        my $x2_element = Rstats::Func::Vector::new_character(lc $x1_element->value);
        push @$x2_elements, $x2_element;
      }
    }
    my $x2 = Rstats::Func::Array::c($r, @$x2_elements);
  ...
  if ($x1->vector->type eq 'character') {
    ...
    for my $x1_element (@{Rstats::Func::decompose($r, $x1)}) {
      if (Rstats::Func::is_na($r, $x1_element)->value) {
        ...
        my $x2_element = Rstats::Func::Vector::new_character(uc $x1_element->value);
        push @$x2_elements, $x2_element;
      }
    }
    my $x2 = Rstats::Func::Array::c($r, @$x2_elements);
...
sub match {
  ...
  return Rstats::Func::Array::new_double($r, @matches);
}

sub abs {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::abs, @_);
}

sub acos {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::acos, @_);
}
sub acosh {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::acosh, @_);
}
...
sub append {
  ...
  $x_after = Rstats::Func::Array::c($r, $x1_length) if Rstats::Func::is_null($r, $x_after);
  ...
  my $x3 = Rstats::Func::Array::c($r, @x3_elements);
...
sub asin {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::asin, @_);
}

sub asinh {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::asinh, @_);
}

sub atan {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::atan, @_);
}

sub atanh {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::atanh, @_);
}
...
sub cbind {
  ...
  return Rstats::Func::Array::NULL() unless @xs;
  ...
  if (Rstats::Func::is_data_frame($r, $xs[0])) {
    ...
    my $data_frame = Rstats::Func::Array::data_frame($r, @data_frame_args);
...
sub ceiling {
  ...
  my $x1 = to_c($r, $_x1);
  my @a2_elements = map { Rstats::Func::Vector::new_double(POSIX::ceil $_->value) } @{Rstats::Func::decompose($r, $x1)};
  
  my $x2 = Rstats::Func::Array::c($r, @a2_elements);
  Rstats::Func::copy_attrs_to($r, $x1, $x2);
...
sub colMeans {
  ...
  if (@$dim_values == 2) {
    ...
    return Rstats::Func::Array::c($r, @$x1_values);
  }
  else {
...
sub cos {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::cos, @_);
}

sub atan2 {
  my $r = shift;
  return operate_binary($r, \&Rstats::Func::Vector::atan2, @_);
}

sub cosh {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::cosh, @_);
}
...
sub cummax {
  ...
  for my $element (@$x1_elements) {
    ...
    if (Rstats::Func::is_na($r, $element)->value) {
      return Rstats::Func::Array::NA();
    }
    elsif (Rstats::Func::is_nan($r, $element)->value) {
      $max = $element;
    }
    if (Rstats::Func::Vector::more_than($element, $max)->value && !Rstats::Func::is_nan($r, $max)->value) {
      $max = $element;
    }
    push @a2_elements, $max;
  }
  
  return Rstats::Func::Array::c($r, @a2_elements);
}
...
sub cummin {
  ...
  for my $element (@$x1_elements) {
    ...
    if (Rstats::Func::Vector::less_than($element, $min)->value && !Rstats::Func::is_nan($r, $min)->value) {
      $min = $element;
    }
    push @a2_elements, $min;
  }
...
sub cumsum {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::cumsum, @_);
}

sub cumprod {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::cumprod, @_);
}
...
sub complex {
  ...
  $x1_mod = Rstats::Func::Array::NULL() unless defined $x1_mod;
  $x1_arg = Rstats::Func::Array::NULL() unless defined $x1_arg;
  ...
  if ($x1_mod->length_value || $x1_arg->length_value) {
    ...
    for (my $i = 0; $i < $longer_length; $i++) {
      ...
      $mod = Rstats::Func::Vector::new_double(1) unless $mod;
      my $arg = $x1_arg_elements->[$i];
      $arg = Rstats::Func::Vector::new_double(0) unless $arg;
      
      my $re = Rstats::Func::Vector::multiply(
        $mod,
        Rstats::Func::Vector::cos($arg)
      );
      my $im = Rstats::Func::Vector::multiply(
        $mod,
        Rstats::Func::Vector::sin($arg)
      );
      
      my $x2_element = Rstats::Func::Vector::complex_double($re, $im);
      push @$x2_elements, $x2_element;
    }
  }
  # Create complex from re and im
    ...
    for (my $i = 0; $i <  $x1_im->length_value; $i++) {
      my $re = $x1_re_elements->[$i] || Rstats::Func::Vector::new_double(0);
  ...
  return Rstats::Func::Array::c($r, @$x2_elements);
}

sub exp {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::exp, @_);
}

sub expm1 {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::expm1, @_);
}
...
sub floor {
  ...
  my @a2_elements = map { Rstats::Func::Vector::new_double(POSIX::floor $_->value) } @{Rstats::Func::decompose($r, $x1)};
...
sub head {
  ...
  if (Rstats::Func::is_data_frame($r, $x1)) {
    ...
    my $x_range = Rstats::Func::Array::se($r, "1:$max");
    my $x2 = $x1->get($x_range, Rstats::Func::Array::NULL());
...
sub i {
  ...
  my $i = Rstats::Func::Vector::new_complex({re => 0, im => 1});
  
  return Rstats::Func::Array::c($r, $i);
}
...
sub ifelse {
  ...
  return Rstats::Func::Array::array($r, c($r, @x2_values));
}

sub log {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::log, @_);
}

sub logb {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::logb, @_);
}

sub log2 {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::log2, @_);
}

sub log10 {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::log10, @_);
}

sub max {
  my $r = shift;
  
  my $x1 = Rstats::Func::Array::c($r, @_);
  ...
  for my $element (@$x1_elements) {
    ...
    if (!Rstats::Func::is_nan($r, $max)->value && Rstats::Func::Vector::more_than($element, $max)->value) {
      $max = $element;
    }
  }
  
  return Rstats::Func::Array::c($r, $max);
}
...
sub mean {
  ...
  my $x2 = divide($r, sum($r, $x1), $x1->length_value);
...
sub min {
  ...
  for my $element (@$x1_elements) {
    ...
    if (!Rstats::Func::is_nan($r, $min)->value && Rstats::Func::Vector::less_than($element, $min)->value) {
      $min = $element;
    }
  }
  
  return Rstats::Func::Array::c($r, $min);
}
...
sub order {
  ...
  return Rstats::Func::Array::c($r, @orders);
}
...
sub rank {
  ...
  return Rstats::Func::Array::c($r, @rank);
}
...
sub paste {
  ...
  return Rstats::Func::Array::c($r, @$x2_values);
}
...
sub pmax {
  ...
  for my $v (@vs) {
    ...
    for (my $i = 0; $i <@$elements; $i++) {
      $maxs[$i] = $elements->[$i]
        if !defined $maxs[$i] || Rstats::Func::Vector::more_than($elements->[$i], $maxs[$i])->value
    }
  }
  
  return  Rstats::Func::Array::c($r, @maxs);
}
...
sub pmin {
  ...
  for my $v (@vs) {
    ...
    for (my $i = 0; $i <@$elements; $i++) {
      $mins[$i] = $elements->[$i]
        if !defined $mins[$i] || Rstats::Func::Vector::less_than($elements->[$i], $mins[$i])->value
    }
  }
  
  return Rstats::Func::Array::c($r, @mins);
}

sub prod {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::prod, @_);
}
...
sub range {
  ...
  return Rstats::Func::Array::c($r, $min, $max);
}
...
sub rbind {
  ...
  if (Rstats::Func::is_data_frame($r, $xs[0])) {
    ...
    for my $name (@$first_names) {
      ...
      my $new_vector = Rstats::Func::Array::c($r, @vectors);
    ...
    return Rstats::Func::Array::t($r, $matrix);
  }
}
...
sub rep {
  ...
  my $x2 = Rstats::Func::Array::c($r, @$elements);
...
sub replace {
  ...
  for (my $i = 0; $i < @$x1_elements; $i++) {
    my $hash = Rstats::Func::Vector::new_double($i + 1)->to_string;
  ...
  return Rstats::Func::Array::array($r, c($r, @$v4_elements));
}
...
sub rnorm {
  ...
  return Rstats::Func::Array::c($r, @x1_elements);
}
...
sub round {
  ...
  my $ro = 10 ** $digits;
  my @a2_elements = map { Rstats::Func::Vector::new_double(Math::Round::round_even($_->value * $ro) / $ro) } @{Rstats::Func::decompose($r, $x1)};
  my $x2 = Rstats::Func::Array::c($r, @a2_elements);
  Rstats::Func::copy_attrs_to($r, $x1, $x2);
  Rstats::Func::mode($r, $x2, 'double');
...
sub sinh {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::sinh, @_);
}

sub sqrt {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::sqrt, @_);
}

sub sort {
  my $r = shift;
  
  my ($x1, $x_decreasing) = Rstats::Func::Array::args_array($r, ['x1', 'decreasing', 'na.last'], @_);
  ...
  my $x3_elements = $decreasing
    ? [reverse sort { Rstats::Func::Vector::more_than($a, $b)->value ? 1 : Rstats::Func::Vector::equal($a, $b)->value ? 0 : -1 } @a2_elements]
    : [sort { Rstats::Func::Vector::more_than($a, $b)->value ? 1 : Rstats::Func::Vector::equal($a, $b)->value ? 0 : -1 } @a2_elements];
...
sub tail {
  ...
  my ($x1, $x_n) = Rstats::Func::Array::args_array($r, ['x1', 'n'], @_);
  ...
  my $x2 = Rstats::Func::Array::c($r, @e2);
  Rstats::Func::copy_attrs_to($r, $x1, $x2);
...
sub tan {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::tan, @_);
}

sub sin {
  my $r = shift;
  operate_unary($r, \&Rstats::Func::Vector::sin, @_);
}
...
sub tanh {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::tanh, @_);
}
...
sub trunc {
  ...
  my @a2_elements
    = map { Rstats::Func::Vector::new_double(int $_->value) } @{Rstats::Func::decompose($r, $x1)};
...
sub median {
  ...
  my $x2 = unique($r, $x1);
  my $x3 = Rstats::Func::Array::sort($r, $x2);
...
sub quantile {
  ...
  my $x2 = Rstats::Func::Array::unique($r, $x1);
  my $x3 = Rstats::Func::Array::sort($r, $x2);
  my $x3_length = $x3->length_value;
  ...
  my $x4 = Rstats::Func::Array::c($r, @$quantile_elements);
  Rstats::Func::names($r, $x4, Rstats::Func::Array::c($r, qw/0%  25%  50%  75% 100%/));
...
sub sd {
  ...
  my $sd = Rstats::Func::Array::sqrt($r, var($r, $x1));
...
sub var {
  ...
  my $var = sum($r, ($x1 - Rstats::Func::Array::mean($r, $x1)) ** 2) / ($x1->length_value - 1);
...
sub new_character {
  ...
  my $x1 = Rstats::Func::Array::NULL();
  $x1->vector(Rstats::Func::Vector::new_character(@_));
}
...
sub new_complex {
  ...
  my $x1 = Rstats::Func::Array::NULL();
  $x1->vector(Rstats::Func::Vector::new_complex(@_));
}
...
sub new_double {
  ...
  my $x1 = Rstats::Func::Array::NULL();
  $x1->vector(Rstats::Func::Vector::new_double(@_));
}
...
sub new_integer {
  ...
  my $x1 = Rstats::Func::Array::NULL();
  $x1->vector(Rstats::Func::Vector::new_integer(@_));
}
...
sub new_logical {
  ...
  my $x1 = Rstats::Func::Array::NULL();
  $x1->vector(Rstats::Func::Vector::new_logical(@_));
}
...
sub matrix {
  ...
  my ($x1, $x_nrow, $x_ncol, $x_byrow, $x_dirnames)
    = Rstats::Func::Array::args_array($r, ['x1', 'nrow', 'ncol', 'byrow', 'dirnames'], @_);
  ...
  my $dim = [$nrow, $ncol];
  my $matrix;
  my $x_matrix = Rstats::Func::Array::NULL();
  $x_matrix->vector(Rstats::Func::Vector::new_vector($x1->vector->type, @$x1_values));
  if ($byrow) {
    $matrix = Rstats::Func::Array::array(
      $r,
      $x_matrix,
      Rstats::Func::Array::c($r, $dim->[1], $dim->[0]),
    );
    
    $matrix = Rstats::Func::Array::t($r, $matrix);
  }
  else {
    $matrix = Rstats::Func::Array::array($r, $x_matrix, Rstats::Func::Array::c($r, @$dim));
  }
...
sub inner_product {
  ...
  # Convert to matrix
  $x1 = Rstats::Func::Array::t($r, Rstats::Func::as_matrix($r, $x1))
    if Rstats::Func::is_vector($r, $x1);
  ...
  if (Rstats::Func::is_matrix($r, $x1) && Rstats::Func::is_matrix($r, $x2)) {
    ...
    for (my $col = 1; $col <= $col_max; $col++) {
      for (my $row = 1; $row <= $row_max; $row++) {
        ...
        my $x2_part = $x2->get(Rstats::Func::Array::NULL(), $col);
        my $x3_part = sum($r, $x1 * $x2);
        push @$x3_elements, $x3_part;
      }
    }
    
    my $x3 = Rstats::Func::Array::matrix($r, c($r, @$x3_elements), $row_max, $col_max);
...
sub row {
  ...
  my $nrow = Rstats::Func::Array::nrow($r, $x1)->value;
  my $ncol = Rstats::Func::Array::ncol($r, $x1)->value;
  
  my @values = (1 .. $nrow) x $ncol;
  
  return Rstats::Func::Array::array($r, Rstats::Func::Array::c($r, @values), Rstats::Func::Array::c($r, $nrow, $ncol));
}

sub sum {
  my $r = shift;
  return operate_unary($r, \&Rstats::Func::Vector::sum, @_);
}
...
sub ncol {
  ...
  if (Rstats::Func::is_data_frame($r, $x1)) {
    return Rstats::Func::Array::c($r, $x1->length_value);
  }
  elsif (Rstats::Func::is_list($r, $x1)) {
    return Rstats::Func::Array::NULL();
  }
  else {
    return Rstats::Func::Array::c($r, Rstats::Func::dim($r, $x1)->values->[1]);
  }
}
...
sub seq {
  ...
  if (defined $_along) {
    ...
    return Rstats::Func::Array::c($r, @$elements);
  }
}
...
sub numeric {
  ...
  return Rstats::Func::Array::c($r, (0) x $num);
}
...
sub add {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::add, @_);
}
sub subtract {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::subtract, @_);
}
sub multiply {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::multiply, @_);
}
sub divide {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::divide, @_);
}
sub remainder {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::remainder, @_);
}
sub pow {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::pow, @_);
}
sub less_than {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::less_than, @_);
}
sub less_than_or_equal {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::less_than_or_equal, @_);
}
sub more_than {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::more_than, @_);
}
sub more_than_or_equal {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::more_than_or_equal, @_);
}
sub equal {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::equal, @_);
}
sub not_equal {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::not_equal, @_);
}
sub and {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::and, @_);
}
sub or {
  my $r = shift;
  operate_binary($r, \&Rstats::Func::Vector::or, @_);
}

sub negation {
  my $r = shift;
  operate_unary($r, \&Rstats::Func::Vector::negation, @_);
}
...
sub _fix_pos {
  ...
  if (ref $data2 eq 'Rstats::Array') {
    ...
    if ($reverse) {
      $x1 = Rstats::Func::Array::c($r, $data2);
      $x2 = $data1;
    }
    else {
      $x1 = $data1;
      $x2 = Rstats::Func::Array::c($r, $data2);
    }
  }
...
sub operate_binary {
  ...
  ($x1, $x2) = Rstats::Func::Array::upgrade_type($r, $x1, $x2) if $x1->vector->type ne $x2->vector->type;
  ...
  if ($x1_length > $x2_length) {
    $x2 = Rstats::Func::Array::array($r, $x2, $x1_length);
    $length = $x1_length;
  }
  elsif ($x1_length < $x2_length) {
    $x1 = Rstats::Func::Array::array($r, $x1, $x2_length);
    $length = $x2_length;
  }
  else {
    $length = $x1_length;
...
sub set {
  ...
  my $x1 = shift;
  my $x2 = Rstats::Func::Array::to_c($r, shift);
  ...
  if (Rstats::Func::is_factor($r, $x1)) {
    ...
    my $x2_elements = Rstats::Func::decompose($r, $x2);
    my $levels_h = Rstats::Func::Array::_levels_h($r, $x1);
    for (my $i = 0; $i < @$poss; $i++) {
      my $pos = $poss->[$i];
      my $element = $x2_elements->[(($i + 1) % @$poss) - 1];
      if (Rstats::Func::is_na($r, $element)->value) {
        $x1_elements->[$pos] = Rstats::Func::Vector::new_logical(undef);
      }
      else {
    ...
    if ($x1->vector->type ne $x2->vector->type) {
      my $x1_tmp;
      ($x1_tmp, $x2) = Rstats::Func::Array::upgrade_type($r, $x1, $x2);
...
sub _levels_h {
  ...
  for (my $i = 1; $i <= @$levels; $i++) {
    $levels_h->{$levels->[$i - 1]} = Rstats::Func::Vector::new_integer($i);
  }
...
sub get {
  ...
  # array
  my $x2 = Rstats::Func::Array::array(
    $r,
    Rstats::Func::Array::new_vector($r, $x1->vector->type, @a2_values),
    Rstats::Func::Array::c($r, @$x2_dim)
  );
  ...
  # level drop
  if ($level_drop) {
    $x2 = Rstats::Func::Array::factor($r, Rstats::Func::as_character($r, $x2));
  }
...
sub is_null {
  ...
  my $x1 = Rstats::Func::Array::to_c($r, shift);
  
  my $x_is = $x1->length_value == 0 ? Rstats::Func::Array::TRUE() : Rstats::Func::Array::FALSE();
...
sub array {
  ...
  unless ($x_dim->vector->length_value) {
    $x_dim = Rstats::Func::Array::c($r, $x1_length);
  }
  my $dim_product = 1;
...
Rstats::Func::Array - Array functions
