...
# get
{
  ...
  # get - have dimnames
  {
    ...
    r->dimnames($x1 => $r->list($r->c_('r1', 'r2', 'r3'), $r->c_('c1', 'c2')));
    my $x2 = $x1->get($r->c_(1, 3), $r->c_(2));
  ...
  {
    my $x1 = $r->c_(1, 3, 5, 7);
    my $logical_v = $r->c_($r->FALSE, $r->TRUE, $r->FALSE, $r->TRUE, $r->TRUE);
  ...
  {
    my $x1 = $r->c_(1, 3, 5, 7);
    my $logical_v = r->as->logical($r->c_(0, 1, 0, 1, 1));
    my $x2 = $x1->get($logical_v);
    is_deeply($x2->values, [3, 7, undef]);
  }
...
# get logical $r->array
{
  # get logical $r->array - basic
  {
    ...
    my $x2 = $r->matrix($r->c_($r->TRUE, $r->FALSE, $r->FALSE, $r->FALSE, $r->TRUE, $r->FALSE, $r->FALSE, $r->FALSE, $r->TRUE), 3, 3);
    my $x3 = $x1->get($x2);
...
# get 3-dimention
{
  ...
  {
    my $x1 = $r->array($r->C('1:24'), $r->c_(4, 3, 2));
    my $x2 = $x1->get($r->c_(-1, -2), $r->c_(-1, -2));
  ...
  {
    my $x1 = $r->array($r->C('1:24'), $r->c_(4, 3, 2));
    my $x2 = $x1->get($r->c_(1, 2, 3, 4), $r->c_(1, 2, 3), $r->c_(1, 2));
  ...
  {
    my $x1 = $r->array($r->c_(map { $_ * 2 } (1 .. 24)), $r->c_(4, 3, 2));
    my $x2 = $x1->get($r->c_(1, 2, 3, 4), $r->c_(1, 2, 3), $r->c_(1, 2));
  ...
  {
    my $x1 = $r->array($r->C('1:24'), $r->c_(4, 3, 2));
    my $x2 = $x1->get($r->c_(2, 3), $r->c_(1, 3), $r->c_(1, 2));
