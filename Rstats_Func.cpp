  ...
  namespace Func {
    ...
    SV* sin(SV* sv_r, SV* sv_x1) {
      ...
      if (strEQ(type, "complex")) {
        sv_x2 = Rstats::Func::operate_unary(sv_r, &Rstats::VectorFunc::sin2<Rstats::Complex>, sv_x1);
      }
      else if (strEQ(type, "double")) {
        sv_x2 = Rstats::Func::operate_unary(sv_r, &Rstats::VectorFunc::sin2<Rstats::Double>, sv_x1);
      }
      else if (strEQ(type, "integer") || strEQ(type, "logical")) {
        sv_x2 = Rstats::Func::operate_unary(sv_r, &Rstats::VectorFunc::sin2<Rstats::Integer>, sv_x1);
      }
      else {
