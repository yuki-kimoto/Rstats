...
# matrix
{
  ...
  # matrix - basic
  {
    my $m1 = $r->array($r->C('1:12'), $r->c(3, 4));
  ...
  # matrix - omit col
  {
    my $m1 = $r->array($r->C('1:12'), $r->c(12, 1));
    is_deeply($m1->values, [1 .. 12]);
  ...
  # matrix - repeat 2
  {
    my $m1 = $r->array($r->C('1:10'), $r->c(3, 4));
